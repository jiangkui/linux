...
`start:2015年12月29日15:31:48`
早上研究了下最近两个月的学习计划，列了一下自己需要学的技术，发现需要学很多。。。
时间貌似不是很够用，需要好好思考下，排个序。
最近还在处理拖延症的问题。从一本书上得到一个解决方案：《拖拉一点也无妨：跟斯坦福萌教授学高效拖延术（拖延症患者也能高效工作） (简单生活)》 kin
从今天开始，先一个周的时间先把 shell 差不多练好。
`end:2015年12月29日18:23:09`

`start:2015年12月31日12:49:16`
这里怎么感觉变成我记录日记的地方了，翻到最上面发现是《鸟哥私房菜》的笔记。。。
好吧，要不要开一个私有的git？ 每月 7$ ... 现在汇率是：1美元 = 6.49595302 人民币
45块钱/月，好吧好贵。。。还是算了。。。转移到印象笔记里面把。
shell 脚本抓取一元夺宝数据的项目暂停，脚本不适合做这种事情。 要么先学 python 要么用java 来做。
如果用 java 来做的话可能会用到多线程之类的知识，python 来做的话就当学习 python了。
恩。。。  在考虑考虑吧。。。
这段时间先把手头这本书速读一遍《Linux Shell 脚本攻略》（第二版） 2015年12月29日21:11:13
先把它看完，shell 基本就入门了。《Linux 命令行 与 shell 脚本编程大全》这本书当工具书用吧，以后用shell多的时候就再回头看。
最近学习效率不高，还是得提升下。就酱。
`end:2015年12月31日12:57:15`